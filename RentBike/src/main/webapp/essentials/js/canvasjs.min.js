...
(this._creditLink=document.createElement("a"),this._creditLink.setAttribute("class","canvasjs-chart-credit"),this._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;visibility:hidden;right:3px;top:"+(this.height-14)+"px;color:dimgrey;text-decoration:none;font-size:10px;font-family:Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),this._creditLink.setAttribute("tabIndex",-1),this._creditLink.setAttribute("target","_blank")),this._toolTip=new Q(this,this._options.toolTip,this.theme),this.axisY2=
...
/*
 * excanvas is used to support IE678 which do not implement HTML5 Canvas
 * Element. You can safely remove the following excanvas code if you don't need
 * to support older browsers.
 * 
 * Copyright 2006 Google Inc. https://code.google.com/p/explorercanvas/ Licensed
