...
const c = o => {
    ...
    h = class {
        constructor(i) {
            o(this, i), this.isVisible = !1, this.mode = d(), this.lazy = !1
        }
        connectedCallback() {
        ...
        loadIcon() {
            if (this.isVisible) {
                const o = s(this);
                o && (a.has(o) ? this.svgContent = a.get(o) : (o => {
                    let i = l.get(o);
                    if (!i) {
                        if ("undefined" == typeof fetch) return a.set(o, ""), Promise.resolve();
                        i = fetch(o).then(i => {
                            if (i.ok) return i.text().then(i => {
                                a.set(o, (o => {
                                    if (o && "undefined" != typeof document) {
                                        ...
                                        i.innerHTML = o;
                                        for (let o = i.childNodes.length - 1; o >= 0; o--) "svg" !== i.childNodes[o].nodeName.toLowerCase() && i.removeChild(i.childNodes[o]);
                    ...
                    return i
                })(o).then(() => this.svgContent = a.get(o)))
            }
            if (!this.ariaLabel) {
