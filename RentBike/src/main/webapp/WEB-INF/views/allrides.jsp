...
<script type="text/javascript" src="essentials/js/allrides.js"></script>
</head>
	...
	<div id="body" style="font-size: 90%;">
		...
		<section class="content">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-10" style="padding-top: 1%;">
						<div id="myRidesDiv" style="margin-left: 20%;">
							<table id="myRidesTable" border="0"
								class="cell-border hover stripe" cellpadding="0" cellspacing="0"
								style="width: 100%;">
								<thead>
									<tr>
										<th width="5%">Ride ID</th>
										<th width="8%">Bike ID</th>
										<th width="10%">From Station</th>
										<th width="10%">To Station</th>
										<th width="15%">Start Date</th>
										<th width="15%">End Date</th>
										<th width="5%">Total Spent</th>
										<th width="15%">Travel Status</th>
									</tr>
								</thead>
							</table>
						</div>
